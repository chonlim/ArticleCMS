...
def login():
	...
	if form.validate_on_submit():
		...
		if user is None or not user.check_password(form.password.data):
			...
			# ADDED LOGGER AS ERROR IF LOGIN INVALID --> DONE
			app.logger.error('A login attempt was invalid!')
			return redirect(url_for('login'))
		login_user(user, remember=form.remember_me.data)
		# ADDED LOGGER AS INFO IF LOGIN IS VALID --> DONE
		app.logger.info('A login attempt was valid and successful!')
